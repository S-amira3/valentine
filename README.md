[index.html](https://github.com/user-attachments/files/25290138/index.html)
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    ...
    <div id="letter-container">
      <div class="letter-window">
        <h1 id="letter-title">Ally, will you be my valentine?</h1>
        ...
        <p id="final-text" class="final-text" style="display: none">
          <strong>Valentine Gift:</strong> There's a video waiting for you! MWAA!
        </p>
      </div>
    </div>
